...
// class CCountryCodePicker extends StatefulWidget {
...
//     this.closeIcon = const Icon(CupertinoIcons.clear_circled, size: 24),
...
//     return CCountryCodePickerState(elements);
//   }
// }

// class CCountryCodePickerState extends State<CCountryCodePicker> {
//   CountryCode? selectedItem;
//   List<CountryCode> elements = [];
//   List<CountryCode> favoriteElements = [];

//   CCountryCodePickerState(this.elements);
...
//                         ? const EdgeInsets.only(right: 16.0, left: 8.0)
//                         : const EdgeInsets.only(right: 0.0), // Changed from 16 to 0
//                     child: Icon(
...
//   @override
//   void didUpdateWidget(CCountryCodePicker oldWidget) {
...
//     final item = await showAdaptiveDialog(
